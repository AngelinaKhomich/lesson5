...
a = [int(i) for i in input("Введите элементы массив").split()]
...
n = int(input("Введите количество элементов:"))
list = [int(i) for i in input("Введите элементы массив").split()]
...
list_letters = {1:"AEIOULNSTRАВЕИНОРСТ",
                ...
                8:"JXШЭЮ",
                10:"QZФЩЪ"}
word = input("Введите слово для подсчета стоимости: ").upper()
summ = 0
for i in word:
